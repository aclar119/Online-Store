...
if(isset($_SESSION["userid"])) {
    if (isset($_GET["productid"])) {
        ...
        if (userHasOrderedProduct($_SESSION["userid"], $_GET["productid"])) {
            echo "true";
        } else {
            echo "false";
        }
    ...
    // One or more GET parameters not set
        ...
        echo "Error in get_has_ordered.php: Product ID not found!";
    }

// Not logged in
} else {
    echo "Error in get_has_ordered.php: Not logged in!";
}